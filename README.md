...
* Go to VS Code terminal and type: ```powershellminikube start --driver=docker```
* Once it is running, you can try ```powershellkubectl get nodes```, to see if kubectl works and gives you a list of nodes in your cluster.
